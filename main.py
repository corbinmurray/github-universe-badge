...
# OPTION 1: Skip menu and go directly to home app
# Comment out this line and uncomment the menu section below to restore menu
app = "/system/apps/home"

# OPTION 2: Show menu to select app (default behavior)
# Uncomment these lines to restore the menu launcher
